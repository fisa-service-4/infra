-- STOCK 스키마 시드 (STOCK 유저로 실행)
-- SECURITIES_ACCOUNT 20건 (1001~1020)
-- STOCK_HOLDING 46건 (삼성전자 35,693 / SK하이닉스 812,061 / 카카오 3,262 기준)
...
-- =============================================
-- 2. STOCK_HOLDING (46건)
-- 가격기준: 삼성전자 35,693 / SK하이닉스 812,061 / 카카오 3,262
-- 잔액이 큰 계좌(1001,1005,1008,1011,1016,1019)는 SK하이닉스 포함 3종목
-- 나머지 14개 계좌는 2종목
-- MERGE ON (SECURITIES_ACCOUNT_ID, STOCK_CODE) → 재실행 보호
-- =============================================
MERGE INTO STOCK_HOLDING t
USING (
    -- 계좌 1001 (user 22, 한국투자): SK하이닉스 2주 + 삼성전자 95주 + 카카오 260주
    ...
    -- 계좌 1020 (user 31, NH): 삼성전자 28주 + 카카오 172주
