-- TRANS 스키마 시드 (TRANS 유저로 실행)
-- USER_MASTER 10건 (user_id = x_user_id = 22~31)
-- USER_ACCOUNT_MAPPING 40건 (BANK 20건 + STOCK 20건)
-- MERGE ON PK → 재실행 보호
SET DEFINE OFF;
...
-- =============================================
-- 2. USER_ACCOUNT_MAPPING
-- PK: (account_id, account_type)
-- BANK  account_id: 2001~2020 / user_id: 22~31 (각 2개)
-- STOCK account_id: 1001~1020 / user_id: 22~31 (각 2개)
-- =============================================
MERGE INTO user_account_mapping t
USING (
    -- BANK 계좌 (account_id 2001~2020)
