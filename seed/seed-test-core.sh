...
cleanup_oracle "BANK/bank123"   "DELETE FROM ACCOUNT_BALANCE_HISTORY;" "DELETE FROM BANK_TRANSACTION;" "DELETE FROM TRANSFER_TRANSACTION;" "DELETE FROM BANK_ACCOUNT;"
