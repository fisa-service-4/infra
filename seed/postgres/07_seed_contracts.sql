...
SELECT 2201, u.user_id, 'A사', 3000000, 'FREELANCER', 3.3, '2026-03-15', '2026-03-15', 'COMPLETED', '2026-03-01'
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2202, u.user_id, 'B사', 4500000, 'FREELANCER', 3.3, '2026-04-10', '2026-04-10', 'COMPLETED', '2026-04-01'
FROM users u WHERE u.firebase_uid = 'test_firebase_001'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2203, u.user_id, 'C사(유지보수)', 2500000, 'FREELANCER', 3.3, '2026-05-12', '2026-05-12', 'COMPLETED', '2026-05-01'
FROM users u WHERE u.firebase_uid = 'test_firebase_001'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2301, u.user_id, '소규모 쇼핑몰', 1200000, 'FREELANCER', 3.3, '2026-03-05', '2026-03-05', 'COMPLETED', '2026-02-20'
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2302, u.user_id, '스타트업A', 4500000, 'FREELANCER', 3.3, '2026-05-08', '2026-05-08', 'COMPLETED', '2026-04-15'
FROM users u WHERE u.firebase_uid = 'test_firebase_002'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2303, u.user_id, 'B사(배너)', 800000, 'FREELANCER', 3.3, '2026-06-02', '2026-06-02', 'COMPLETED', '2026-05-25'
FROM users u WHERE u.firebase_uid = 'test_firebase_002'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2501, u.user_id, '패션브랜드A', 3500000, 'FREELANCER', 3.3, '2026-03-07', '2026-03-07', 'COMPLETED', '2026-02-15'
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2502, u.user_id, '쇼핑몰B', 4800000, 'FREELANCER', 3.3, '2026-04-11', '2026-04-11', 'COMPLETED', '2026-03-20'
FROM users u WHERE u.firebase_uid = 'test_firebase_004'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2503, u.user_id, '랜딩페이지C', 2700000, 'FREELANCER', 3.3, '2026-05-15', '2026-05-15', 'COMPLETED', '2026-05-01'
FROM users u WHERE u.firebase_uid = 'test_firebase_004'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2601, u.user_id, '부트캠프 운영사', 7000000, 'FREELANCER', 3.3, '2026-06-05', '2026-06-05', 'COMPLETED', '2026-05-15'
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2602, u.user_id, '기업교육센터', 1500000, 'FREELANCER', 3.3, '2026-07-12', '2026-07-12', 'COMPLETED', '2026-06-20'
FROM users u WHERE u.firebase_uid = 'test_firebase_005'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2603, u.user_id, '온라인플랫폼', 800000, 'FREELANCER', 3.3, '2026-08-08', '2026-08-08', 'COMPLETED', '2026-07-30'
FROM users u WHERE u.firebase_uid = 'test_firebase_005'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2801, u.user_id, '미국 SaaS 스타트업', 12000000, 'FREELANCER', 0.0, '2026-03-04', '2026-03-04', 'COMPLETED', '2026-02-10'
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2802, u.user_id, '미국 핀테크 기업', 15000000, 'FREELANCER', 0.0, '2026-04-05', '2026-04-05', 'COMPLETED', '2026-03-15'
FROM users u WHERE u.firebase_uid = 'test_firebase_007'
ON CONFLICT (contract_id) DO NOTHING;
...
INSERT INTO contract (contract_id, user_id, client_name, contract_amount, tax_type, tax_rate, expected_payment_date, actual_payment_date, contract_status, created_at)
SELECT 2803, u.user_id, '고객사 유지보수', 10000000, 'FREELANCER', 0.0, '2026-05-06', '2026-05-06', 'COMPLETED', '2026-04-20'
FROM users u WHERE u.firebase_uid = 'test_firebase_007'
ON CONFLICT (contract_id) DO NOTHING;
